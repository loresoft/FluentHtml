...
namespace FluentHtml.Tests
{
    public static class MvcHelper
    {
        ...
        static MvcHelper()
        {
            RouteCollection rt = RouteTable.Routes;
        ...
        public static HtmlHelper<object> GetHtmlHelper(string username, string[] roles)
        {
            HttpContextBase httpcontext = GetHttpContext("/app/", null, null, Uri.UriSchemeHttp, -1, username, roles);
        ...
        public static HttpContextBase GetHttpContext(string appPath, string requestPath, string httpMethod, string protocol, int port, string username = "test.user", string[] roles = null)
        {
            ...
            mockHttpContext.Setup(o => o.User).Returns(principal);
